...
<body class="bg-stone-950">
    ...
    <div class="mt-6 mx-auto px-4 bg-stone-950">
        ...
        <div class="p-6 text-medium text-stone-50 rounded w-full md:w-3/5 lg:w-2/5 min-h-screen">
            <h3 class="text-lg font-bold text-stone-100 text-white mb-2">Opleiding <?php echo $editmode ? "bewerken": "toevoegen" ?></h3>
            <p class="mb-2"></p>
            <br>
            <form method="POST" action="<?php echo $actionUrl ?>" class="w-full">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <textarea 
                            ...
                            name="description" 
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                            placeholder="<?php echo isset( $descriptionValue ) ? $descriptionValue : "" ?>">
                        </textarea>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                        <label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="registerUntil">
                            Inschrijven tot ...
                        </label>
                    </div>
                    <div class="md:w-2/3">
                ...
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                        <label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="graduateUntil">
                            Diplomeren tot ...
                        </label>
                    </div>
                    <div class="md:w-2/3">
