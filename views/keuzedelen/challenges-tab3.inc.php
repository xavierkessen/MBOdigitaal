...
<table class="table-auto w-full border-collapse border border-gray-400 mb-8">
    ...
    <tbody>
        ...
        <tr>
            <td class="border border-gray-300 px-4 py-2">Vullen van de database met 10 voorbeeld records.
                <b>(Individueel)</b></td>
            <td class="border border-gray-300 px-4 py-2 font-bold text-center">6</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="border border-gray-300 px-4 py-2">Presentatie over de beste keuze voor mbogodigital.nl: SQL of
                noSQL? <b>(Groep)</b></td>
